...
namespace LibgenDesktop.ViewModels
{
    internal class ImportLogPanelViewModel : ViewModel
    {
        internal class ImportLogItemViewModel : ViewModel
        {
            ...
            public ImportLogItemViewModel(int? stepIndex, string headerText)
            {
                this.stepIndex = stepIndex.HasValue ? $"Шаг {stepIndex.Value}" : String.Empty;
                isStepIndexVisible = stepIndex.HasValue;
        ...
        public void AddLogItem(int? stepIndex, string headerText, string logLine = null)
        {
