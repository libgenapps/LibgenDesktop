...
namespace LibgenDesktop.ViewModels
{
    internal class SciMagSearchResultsTabViewModel : TabViewModel
    {
        ...
        public SciMagSearchResultsTabViewModel(MainModel mainModel, IWindowContext mainWindowContext, string searchQuery, ObservableCollection<SciMagArticle> searchResults)
        ...
        {
            SciMagDetailsWindowViewModel detailsWindowViewModel = new SciMagDetailsWindowViewModel(MainModel, article);
            IWindowContext detailsWindowContext = WindowManager.CreateWindow(RegisteredWindows.WindowKey.SCI_MAG_DETAILS_WINDOW, detailsWindowViewModel, MainWindowContext);
